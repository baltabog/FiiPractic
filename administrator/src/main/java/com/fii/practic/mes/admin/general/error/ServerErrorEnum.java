...
public enum ServerErrorEnum {
	...
	UPDATE_PROCESS_STEP_USED_IN_PROCESS_PLAN(400, "Process step named <%s> can't be updated because it is already used by a process plan", Constants.ENTITY_NAME, Constants.ENTITY_NAME),
	...
	UPDATE_PROCESS_PLAN_USED_IN_ORDER(400, "Process plan named <%s> can't be updated because it is already used by an order", Constants.ENTITY_NAME, Constants.ENTITY_NAME)
	;
