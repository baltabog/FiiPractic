...
public interface OrderApi {
    ...
    @DELETE
    void deleteOrder(@QueryParam("uuid") @NotNull @Size(min=1,max=36)   String uuid,@QueryParam("version") @NotNull   Integer version);

    @POST
    @Path("/search")
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    List<OrderDTO> searchOrders(@Valid SearchType searchType);

    @PUT
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    OrderDTO updateOrder(@Valid @NotNull OrderDTO orderDTO);
}
