...
@JsonTypeName("FilterParamCriteriaGroupType")
...
public class FilterParamCriteriaGroupType  implements Serializable {
  ...
  /**
   **/
  public FilterParamCriteriaGroupType criteria(List<@Valid FilterParamCriteriaType> criteria) {
  ...
  @NotNull @Valid public List<@Valid FilterParamCriteriaType> getCriteria() {
    return criteria;
  }
  ...
  public FilterParamCriteriaGroupType addCriteriaItem(FilterParamCriteriaType criteriaItem) {
  ...
  public FilterParamCriteriaGroupType removeCriteriaItem(FilterParamCriteriaType criteriaItem) {
  ...
  /**
   **/
  public FilterParamCriteriaGroupType outerOperator(OuterOperatorEnum outerOperator) {
  ...
  /**
   **/
  public FilterParamCriteriaGroupType criteriaGroups(List<@Valid FilterParamCriteriaGroupType> criteriaGroups) {
  ...
  public FilterParamCriteriaGroupType addCriteriaGroupsItem(FilterParamCriteriaGroupType criteriaGroupsItem) {
  ...
  public FilterParamCriteriaGroupType removeCriteriaGroupsItem(FilterParamCriteriaGroupType criteriaGroupsItem) {
  ...
  public boolean equals(Object o) {
    ...
    FilterParamCriteriaGroupType filterParamCriteriaGroupType = (FilterParamCriteriaGroupType) o;
    return Objects.equals(this.criteria, filterParamCriteriaGroupType.criteria) &&
        Objects.equals(this.outerOperator, filterParamCriteriaGroupType.outerOperator) &&
        Objects.equals(this.criteriaGroups, filterParamCriteriaGroupType.criteriaGroups);
  }

  @Override
  public int hashCode() {
    return Objects.hash(criteria, outerOperator, criteriaGroups);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FilterParamCriteriaGroupType {\n");
