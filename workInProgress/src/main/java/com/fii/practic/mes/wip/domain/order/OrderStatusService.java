...
public class OrderStatusService {
    ...
    public OrderStatusDTO getOrderStatusByName(String name) {
        ...
        OrderDTO adminOrder = getAdminOrderByName(name);
        return mapper.toOrderStatusDto(adminOrder, OrderStatusType.ON_HOLD);
    }

    private OrderDTO getAdminOrderByName(String name) {
